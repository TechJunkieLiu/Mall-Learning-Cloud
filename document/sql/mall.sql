...
CREATE TABLE `flyway_test`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '测试表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of flyway_test
-- ----------------------------
INSERT INTO `flyway_test` VALUES (8, 'lzq1', NULL, '2024-09-11 15:27:13');
INSERT INTO `flyway_test` VALUES (9, 'lzq2', NULL, '2024-09-11 15:27:13');
...
-- ----------------------------
INSERT INTO `schema_version` VALUES (1, '1.0', 'init table', 'SQL', 'V1.0__init_table.sql', 164888000, 'root', '2024-09-11 15:27:12', 2451, 1);
INSERT INTO `schema_version` VALUES (2, '1.1', 'init data', 'SQL', 'V1.1__init_data.sql', 662652088, 'root', '2024-09-11 15:27:13', 1129, 1);
INSERT INTO `schema_version` VALUES (3, '1.2.0', 'flyway test create table', 'SQL', 'V1.2.0__flyway_test_create_table.sql', -2098261535, 'root', '2024-09-11 15:27:13', 29, 1);
INSERT INTO `schema_version` VALUES (4, '1.2.1', 'flyway test add data', 'SQL', 'V1.2.1__flyway_test_add_data.sql', 869407544, 'root', '2024-09-11 15:27:13', 10, 1);
INSERT INTO `schema_version` VALUES (5, '1.2.2', 'flyway test update field', 'SQL', 'V1.2.2__flyway_test_update_field.sql', -29251281, 'root', '2024-09-11 15:27:13', 81, 1);
INSERT INTO `schema_version` VALUES (6, NULL, 'flyway test view', 'SQL', 'R__flyway_test_view.sql', -1863947971, 'root', '2024-09-11 15:27:13', 10, 1);
...
-- ----------------------------
INSERT INTO `ums_admin` VALUES (1, 'admin', '$2a$10$NZ5o7r2E.ayT2ZoxgjlI.eJ6OEYqjH7INR/F.mXDbjZJi9HF0YCVG', 'https://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/icon/github_icon_01.png', 'admin@139.com', '超级管理员', '超级管理员权限', '2024-09-11 15:27:13', NULL, 1);
...
-- ----------------------------
INSERT INTO `ums_admin_login_log` VALUES (1, 1, '2024-09-11 15:27:13', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (2, 1, '2024-09-11 15:27:13', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (3, 1, '2024-09-11 15:27:13', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (4, 1, '2024-09-11 15:27:13', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (5, 1, '2024-09-11 15:27:13', '0:0:0:0:0:0:0:1', NULL, NULL);
...
-- Records of ums_role
-- ----------------------------
INSERT INTO `ums_role` VALUES (1, '超级管理员', '所有查看、操作功能', 0, '2024-09-11 15:27:13', 1, 0);
INSERT INTO `ums_role` VALUES (2, '商品管理员', '只能查看、操作商品', 0, '2024-09-11 15:27:13', 1, 0);
INSERT INTO `ums_role` VALUES (3, '订单管理员', '只能查看、操作订单', 0, '2024-09-11 15:27:13', 1, 0);
INSERT INTO `ums_role` VALUES (4, '营销管理员', '只能查看、操作营销', 0, '2024-09-11 15:27:13', 1, 0);
INSERT INTO `ums_role` VALUES (5, '权限管理员', '只能查看、操作权限', 0, '2024-09-11 15:27:13', 1, 0);
...
-- ----------------------------
-- View structure for flyway_test_view
-- ----------------------------
DROP VIEW IF EXISTS `flyway_test_view`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `flyway_test_view` AS select `flyway_test`.`username` AS `username`,`flyway_test`.`create_time` AS `create_time` from `flyway_test`;
